...
routes.route(routeNames.getUsers).get(authJwt.verifyToken, authJwt.authAdmin, userController.getUsers)
routes.route(routeNames.delete).post(authJwt.verifyToken, authJwt.authAdmin, userController.deleteUsers)
