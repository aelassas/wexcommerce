...
const orderSchema = new Schema({
  ...
  status: {
    type: String,
    enum: [wexcommerceTypes.OrderStatus.Pending, wexcommerceTypes.OrderStatus.Paid, wexcommerceTypes.OrderStatus.Confirmed, wexcommerceTypes.OrderStatus.InProgress, wexcommerceTypes.OrderStatus.Cancelled, wexcommerceTypes.OrderStatus.Shipped],
    required: [true, "can't be blank"]
  },
  orderItems: {
    type: [Schema.Types.ObjectId],
