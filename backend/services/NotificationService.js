...
export default class NotificationService {
    ...
    static getNotificationCounter(context, userId) {
        return axios.get(`${Env.API_HOST}/api/notification-counter/${encodeURIComponent(userId)}`, { headers: UserService.authHeader(context) }).then(res => res.data);
    }
    ...
    static getNotifications(context, userId, page) {
        return axios.get(`${Env.API_HOST}/api/notifications/${encodeURIComponent(userId)}/${page}/${Env.PAGE_SIZE}`, { headers: UserService.authHeader(context) })
            .then(res => res.data);
    }
