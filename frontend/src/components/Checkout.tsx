...
interface CheckoutProps {
  ...
  paymentTypes: wexcommerceTypes.PaymentTypeInfo[]
  deliveryTypes: wexcommerceTypes.DeliveryTypeInfo[]
}
...
const Checkout: React.FC<CheckoutProps> = (
  ...
  const [paymentType, setPaymentType] = useState<wexcommerceTypes.PaymentType>(paymentTypes && paymentTypes.length === 1 ? (paymentTypes[0].name as wexcommerceTypes.PaymentType) : wexcommerceTypes.PaymentType.CreditCard)
  ...
  return (
    ...
    <>
      <div className={styles.checkout}>
        {(cart && paymentTypes && total > 0 && !success) &&
          <>
