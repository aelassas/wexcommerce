...
const enableSentry = process.env.WC_ENABLE_SENTRY?.trim().toLowerCase() === 'true'
const dsn = process.env.WC_SENTRY_DSN_BACKEND?.trim()
const rawRate = process.env.WC_SENTRY_TRACES_SAMPLE_RATE?.trim()
